...
if __name__ == "__main__":
    ...
    scores = []
    avg_lengths = []
    with open("data/pointer-generator/articles.txt") as src:
        with open("data/pointer-generator/decoded.txt") as gen:
    ...
    np.save("experiments/pointer-generator/scores", scores)
    np.save("experiments/pointer-generator/avg_lengths", avg_lengths)
